...
| Testing | JUnit 5 + Testcontainers | 68 tests, 80% coverage enforced |
...
- **68 automated tests** — unit tests with Mockito, integration tests with real Postgres via Testcontainers, Kafka consumer tests with EmbeddedKafka
